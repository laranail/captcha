...
final class DoctorCommand extends Command
{
    ...
    private function problems(
        ...
        // Not fatal, and deliberately reported anyway. An empty allow-list means the hostname
        // check does nothing, so a token minted on someone else's copy of your form verifies here.
        if ($config->bool('verification.enforce_hostname', true)
