...
[![Packagist Version](https://img.shields.io/packagist/v/laranail/captcha.svg?style=flat-square)](https://packagist.org/packages/laranail/captcha)
...
This family resolves through git VCS repositories rather than Packagist; the entries are already in
